	...
	return (
		...
		>
			<div className="w-full md:w-1/3 text-left">
				...
				>
					Beyond Apex Tech is a team of freelancers with good experience of working in IT industry and good at providing technical solutions for the business requirements.
				</motion.p>
				<motion.div
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
